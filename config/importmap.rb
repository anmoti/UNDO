...
if Rails.env.development?
  ...
  pin "valibot", to: "valibot/dist/index.js"
else
  ...
  pin "valibot", to: "https://cdn.jsdelivr.net/npm/valibot@1.1.0/+esm"
end
# ローカルからロードできないのでCDNからロード
pin "ky", to: "https://cdn.jsdelivr.net/npm/ky@1.11.0/+esm"
